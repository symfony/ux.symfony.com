...
class RecipeFileTree
{
    ...
    public function __construct()
    {
        $this
            ...
            ->addFile('package.json', 'Holds your Node dependencies, when you build your assets with a bundler.')
            ->addFile('vite.config.ts', 'Vite configuration, with the Symfony Reprise plugin wired in.')
            ->addFile('rsbuild.config.ts', 'Rsbuild configuration, with the Symfony Reprise plugin wired in.')
        ;
    }
